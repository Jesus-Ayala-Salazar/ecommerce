...
public class CartServlet extends HttpServlet{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        contents.append("<div class=\"center col-12 col-s-12\">\n" +
                ...
                "    </div>\n" +
                "\n" +
                "    <form action=\"OrderDetailsServlet\" method=\"GET\" class=\"center\">\n" +
                "\n" +
                "        <!-- Row -->\n" +
                ...
                "                    <option value=\"2dayExpedited\">2-Day Expedited Shipping</option>\n" +
                "                    <option value=\"6dayGround\">6-day Ground Shipping</option>\n" +
                "                </select>\n" +
                "            </div>\n" +
                "        </div>\n" +
                "\n" +
